...
<body class="vertical-layout vertical-menu-modern 1-column  bg-white bg-lighten-2 menu-expanded fixed-navbar"
...
<button type="submit" class="btn btn-danger btn-block btn-lg" name="login"><i class="ft-unlock"></i> Login</button>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2023 <a class="text-bold-800 grey darken-2" href="../index.php"
        target="_blank">ραи∂ι•🦋</a>, All rights reserved. 
    </p>
  </footer>
  <!-- BEGIN VENDOR JS-->
