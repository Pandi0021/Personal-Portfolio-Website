...
<head>
  <title>Contact form Admin- Todays Contacts</title>
    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Today's Contacts</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Today's Contacts
                </li>
              </ol>
            </div>
          </div>
...
$sql = "SELECT FullName,PhoneNumber,PostingDate,id,Is_Read from tblcontactdata where date(PostingDate)=CURDATE()";
