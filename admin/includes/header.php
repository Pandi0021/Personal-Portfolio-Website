          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1">ραи∂ι•🦋
                  <span class="user-name text-bold-700"><?php echo htmlentities(ucfirst($_SESSION['userlogin']));?></span>
                </span>
                <span class="avatar avatar-online">
                  <img src="https://imgs.search.brave.com/52_9FVFbdz94GdGNkLVO3U2Neg0cBeUmqPhPA9gXUYQ/rs:fit:512:512:1/g:ce/aHR0cHM6Ly9jZG4w/Lmljb25maW5kZXIu/Y29tL2RhdGEvaWNv/bnMvY3JpbWUtcHJv/dGVjdGlvbi1wZW9w/bGUvMTEwL0hhY2tl/ci01MTIucG5n" alt="avatar"><i></i></span>
              </a>
